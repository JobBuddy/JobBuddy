# Generated by Django 2.0.8 on 2019-04-08 07:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidate', models.ManyToManyField(to='accounts.CandidateProfile')),
            ],
        ),
        migrations.CreateModel(
            name='Recruiter',
        ...
        migrations.AddField(
            ...
            name='jobs',
            field=models.ManyToManyField(to='accounts.Jobs'),
        ),
    ]
